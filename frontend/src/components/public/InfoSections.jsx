  ...
  const guides = [
    {
      status: "Éligible",
      color: "emerald",
      text: "Vous répondez aux critères requis. Vous pouvez créer un compte et déposer votre dossier.",
    },
    {
      status: "En attente",
      color: "amber",
      text: "Votre dossier est en cours de vérification par nos équipes techniques.",
    },
    {
      status: "Non éligible",
      color: "rose",
      text: "Votre profil ne répond pas aux critères. Consultez la raison détaillée sur votre espace.",
    },
  ];
    ...
    <section className="py-24 bg-white">
      <div className="container-custom">
        <div className="mb-16 text-center">
          <h2 className="section-title-center text-3xl md:text-4xl text-center">Comprendre les statuts</h2>
        </div>
...
export function FaqSection() {
  const faqs = [
    { q: "Qui peut bénéficier de la bourse ?", a: "Tous les étudiants répondant aux critères sociaux et académiques définis par le CNOU." },
    { q: "Quels documents sont nécessaires pour le dossier ?", a: "Pièce d'identité, certificat de scolarité, relevés de notes et justificatifs de revenus selon votre profil." },
    { q: "Combien de temps prend le traitement du dossier ?", a: "Le délai moyen est de 15 à 30 jours ouvrables selon la période de l'année." },
    { q: "Comment savoir si mon paiement est effectué ?", a: "Le statut 'Payé' apparaîtra dans votre espace personnel après confirmation du partenaire de paiement." },
  ];
      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-6">
            <h2 className="section-title text-3xl md:text-4xl mb-16">Questions fréquentes</h2>
          ...
          <div className="lg:col-span-6 relative">
            <div className="faq-help-circles aspect-square max-w-[500px] mx-auto">
              ...
              <div className="relative bg-white p-12 rounded-full shadow-2xl border border-slate-100 text-center flex flex-col items-center max-w-[80%] aspect-square justify-center z-10">
                ...
                <h3 className="text-2xl font-display font-bold text-slate-900 mb-4">Besoin d&apos;aide ?</h3>
