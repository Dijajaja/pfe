...
const resources = {
  fr: {
    translation: {
      ...
      eligibilitySubtitle: "Cette vérification est locale (MVP) en attendant l’API officielle.",
      backHome: "Retour",
      fieldNni: "Numéro NNI",
      ...
      eligibilityNote:
        "Quand l’endpoint backend sera prêt, ce formulaire appellera l’API et remplacera cette logique client.",
  ...
  ar: {
    translation: {
      ...
      eligibilitySubtitle: "هذا فحص محلي (نسخة أولية) إلى حين جاهزية الـ API.",
      backHome: "رجوع",
      fieldNni: "رقم الهوية",
      ...
      eligibilityNote: "عند جاهزية الـ API في الخادم، سيتم استدعاء الواجهة البرمجية بدل منطق الواجهة فقط.",
